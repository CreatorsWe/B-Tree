...
template <class T>
void BTree<T>::Insert(shared_ptr<Bnode<T>> &_node,const int& _index,const T& _data,bool& _isupdate)
{
...
template <class T>
Bnode<T> *BTree<T>::splitNode(shared_ptr<Bnode<T>> &_node, const int& _midpos,const bool _isfirstptrpos)
{
